...
function AddBlog() {
  return (
    <>
        <PageHeading heading="Add Blog" breadCrumb={[{label:'AddBlog',path:'/admin/blog/new'}]} />

        <form className='grid grid-cols-2 gap-y-8 gap-x-5'>
            <div className="white-box-cont">
                <InputField_v1 inputType="input" label="Title" type="text" name="title" placeholder="Add blog title" required="true" hint="Do not exceed 40 characters when entering the product name."   />
